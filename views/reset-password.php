    ...
    <body>
        ...
        <form method="post">
            ...
            <table cellpadding="5" cellspacing="5">
                ...
                <tr>
                    <td class="head"><label>New Password</label></td><td><input class="field" type="password" name="npassword" placeholder="New Password"></td>
                </tr>
                <tr>
                    <td class="head"><label>Confirm Password</label></td><td><input class="field" type="password" name="cpassword" placeholder="Confirm Password"></td>
                </tr>
