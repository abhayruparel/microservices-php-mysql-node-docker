...
<div id="page-wrapper">
    ...
    <p class="col-sm-12"><?php //echo phpinfo(); 
                            ?></p>
    <div class="row">
        <div class=" col-sm-4 offset-md-4">
            <?php
			// Kang of https://github.com/dayvonjersen/hostInfo
            // I am a shitlord.
...
CSS;
            ...
            $body['h2'] = "Hostname: " . $hostname;
            $body['h3'] = "Uptime: " . $uptime;
            $body['h4'] = date('l jS F Y G:i:s e');
            $body['table'] = array();

            foreach ($specs as $category => $data) {
                $myTable = [
                    '__attributes' => ['id' => strtolower($category)],
                    'thead'       =>
                    [
                        'tr' =>
            ...
            $body['div'] = "Server software: " . $_SERVER['SERVER_SOFTWARE'] . ' @ ' . $_SERVER['SERVER_NAME'] . ':' . $_SERVER['SERVER_PORT'];
